...
$team_members = get_theme_mod('team_members', [
    [
        ...
        'bio' => __('Spécialiste en orthodontie depuis 15 ans, passionnée par les techniques modernes et les approches personnalisées pour chaque patient.',
        'icon' => 'face_6'
    ],
    [
        'name' => __('Dr. Pierre Dupont', 'orthosmile'),
        'position' => __('Orthodontiste Pédiatrique', 'orthosmile'),
        'bio' => __('Expert en prise en charge précoce des enfants, il allie expertise médicale et approche bienveillante pour un suivi serein.',
        'icon' => 'face_3'
    ],
    [
        'name' => __('Dr. Camille Bernard', 'orthosmile'),
        'position' => __('Orthodontiste Invisalign', 'orthosmile'),
        'bio' => __('Certifiée Invisalign depuis 8 ans, elle accompagne les patients adultes dans leur parcours de traitement discret.',
        'icon' => 'visibility_off'
    ]
]);
?>
    ...
    <div class="container">
        ...
        <div class="team-grid">
            <?php foreach ($team_members as $index => $member) : ?>
                <div class="team-card fade-in-up" style="animation-delay: <?php echo $index * 0.1; ?>s">
                    <div class="team-image">
                        <span class="material-symbols-outlined"><?php echo esc_html($member['icon']); ?></span>
                    </div>
                    <div class="team-content">
                        <h3 class="team-name"><?php echo esc_html($member['name']); ?></h3>
                        <div class="team-position"><?php echo esc_html($member['position']); ?></div>
                        <p class="team-bio"><?php echo esc_html($member['bio']); ?></p>
                        <a href="#contact" class="btn btn-secondary"><?php esc_html_e('Prendre rendez-vous', 'orthosmile'); ?></a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
