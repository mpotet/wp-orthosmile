...
$footer_desc   = orthosmile_get_option( 'footer_description', '' );
$footer_legal  = orthosmile_get_option( 'footer_legal', '' );
...
$socials = [
    'facebook'  => [
        'url'   => orthosmile_get_option( 'facebook_url', '' ),
        'label' => 'Facebook',
    ...
    'instagram' => [
        'url'   => orthosmile_get_option( 'instagram_url', '' ),
        'label' => 'Instagram',
    ...
    'linkedin'  => [
        'url'   => orthosmile_get_option( 'linkedin_url', '' ),
        'label' => 'LinkedIn',
    ...
    'youtube'   => [
        'url'   => orthosmile_get_option( 'youtube_url', '' ),
        'label' => 'YouTube',
        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                ...
                <?php elseif ( $logo_url = orthosmile_get_option( 'logo_url', '' ) ) : ?>
                    <div style="margin-bottom:.875rem;max-width:160px;">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                            <img src="<?php echo esc_url( $logo_url ); ?>"
                                 alt="<?php echo esc_attr( $cabinet_name ); ?>"
                                 style="filter:brightness(0) invert(1);opacity:.85;max-height:60px;width:auto;">
                        </a>
                    </div>
                <?php else : ?>
