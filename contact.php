...
<main id="main" class="site-main">
    ...
    <div class="page-banner">
        <div class="container">
            <h1 class="page-banner-title"><?php esc_html_e( 'Contactez-nous', 'orthosmile' ); ?></h1>
            <p class="page-banner-subtitle"><?php esc_html_e( 'Nous sommes à votre écoute pour répondre à toutes vos questions et vous accompagner dans votre parcours orthodontique.', 'orthosmile' ); ?></p>
        </div>
    </div>
        ...
        <div class="contact-page">
            <div class="contact-container">
                ...
                <div class="contact-info-card">
                    <h3><?php esc_html_e( 'Nos Coordonnées', 'orthosmile' ); ?></h3>
                    ...
                    <?php if ( $contact['opening_hours'] ) : ?>
                    <div class="contact-item">
                        <div class="contact-icon">
                            <span class="material-symbols-outlined" aria-hidden="true">schedule</span>
                        </div>
                        <div class="contact-details">
                            <h4><?php esc_html_e( "Horaires d'ouverture", 'orthosmile' ); ?></h4>
